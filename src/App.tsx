...
export default function App() {
  ...
  const handleConfirmValue = (txId: string) => {
            ...
            <div>
              <div className="bg-gradient-to-br from-red-100/80 via-yellow-100/80 to-blue-100/80 backdrop-blur-xl p-10 rounded-[3rem] border border-white/50 shadow-sm">
                ...
                <form onSubmit={handleSendToken} className="space-y-8">
                  ...
                  <button 
                    type="submit"
                    disabled={!sendTargetId || !sendAmount || !sendNote}
                    className="w-full bg-indigo-600 text-white py-6 rounded-[2rem] font-black text-xl shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition-all disabled:opacity-50 disabled:bg-gray-300"
                  >
                    가치 인정하기
                  </button>
                </form>
            ...
            >
              ...
              <form onSubmit={handleSendToken} className="flex flex-col gap-6">
                ...
                <div className="flex gap-4 mt-6">
                  ...
                  <button 
                    type="submit"
                    className="flex-[2] bg-indigo-600 text-white font-black py-5 rounded-2xl shadow-xl shadow-indigo-200 hover:bg-indigo-700 transition-all active:scale-95"
                  >
                    보내기
                  </button>
                </div>
